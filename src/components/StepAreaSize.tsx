...
const options = [
  { value: "1-car", label: "Space for 1 car" },
  { value: "2-cars", label: "Space for 2 cars" },
  { value: "3-plus-cars", label: "Space for 3 or more cars" },
  { value: "small-patio", label: "Small patio/garden area" },
  { value: "medium-patio", label: "Medium patio/garden area" },
  { value: "large-garden", label: "Large garden project" },
  { value: "not-sure", label: "Not sure" },
];

export default function StepAreaSize({
  value,
  onChange,
}: {
  value: string;
  ...
  return (
    <div className="space-y-2">
      <p className="text-[13px] text-dark-text/50 -mt-3 mb-3">You do not need exact measurements.</p>
