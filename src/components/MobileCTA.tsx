export default function MobileCTA() {
  return (
    <div className="home-mobile-cta fixed left-0 right-0 bottom-0 z-60 bg-white border-t border-border p-[10px_16px] flex gap-[10px] shadow-[0_-8px_20px_-10px_rgba(0,0,0,.2)] sm:hidden">
