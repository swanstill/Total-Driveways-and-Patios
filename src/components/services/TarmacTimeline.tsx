...
const steps = [
  {
    ...
    desc: "Measure the area, review the existing surface, access, expected traffic, drainage and preferred border design.",
    icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z",
  },
  {
    num: "02",
    title: "Clearance & Excavation",
    desc: "Remove unsuitable material and establish the correct formation level while protecting nearby structures and services.",
    icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z",
  },
  {
    num: "03",
    title: "Sub-Base & Edging",
    desc: "Install and compact the load-bearing foundation, build secure restraints and set the required falls and drainage.",
    icon: "M3 3h18v18H3V3z M9 3v18 M15 3v18 M3 9h18 M3 15h18",
  },
  {
    num: "04",
    title: "Tarmac Laying & Rolling",
    desc: "Lay the hot material evenly, compact it thoroughly and complete neat joins around borders, covers and entrances.",
    icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
  },
  {
    num: "05",
    title: "Cooling & Handover",
    desc: "Keep vehicles off the new surface for the advised period, remove waste and explain early-use precautions.",
    icon: "M5 13l4 4L19 7",
  },
];
...
export default function TarmacTimeline() {
  return (
    <section className="relative py-[120px]" style={{ background: "var(--svc-section)" }}>
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            How We Install Tarmac Driveways
          </motion.h2>
        </motion.div>
