...
export default function TarmacOptions() {
  return (
    <section className="py-[120px]" style={{ background: "var(--svc-section)" }}>
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        >
          ...
          >
            Tarmac finishes offer practical choices to suit different property styles and
            functional requirements, from classic black to decorative edged options.
          </motion.p>
        </motion.div>
