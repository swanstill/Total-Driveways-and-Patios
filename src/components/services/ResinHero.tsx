      ...
      <div className="max-w-[1280px] mx-auto px-6 w-full relative z-10 py-[30px] lg:py-0">
        ...
        >
          ...
          <div className="max-w-[580px]">
            ...
            >
              <span className="block">Resin Driveways</span>
            ...
            >
              Choose a smooth, decorative resin-bound surface with a consistent finish and a wide
              selection of natural aggregate colours. Total Driveways and Patios will assess the
              existing base, drainage, edging and intended use before recommending the right
              construction for your property.
            </motion.p>
