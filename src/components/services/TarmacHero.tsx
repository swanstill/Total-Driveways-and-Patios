...
export default function TarmacHero() {
  return (
    <section
    ...
    >
      ...
      {/* Top-right decorative corner bracket */}
      <div
      ...
      <div className="max-w-[1280px] mx-auto px-6 w-full relative z-10 py-[30px] lg:py-0">
        ...
        >
          ...
          <div className="max-w-[580px]">
            ...
            >
              <span className="block">Tarmac Driveways</span>
            ...
            >
              A professionally laid tarmac driveway provides a smooth, practical surface for
              everyday vehicle use. Total Driveways and Patios can prepare and install domestic
              driveways, paths and access areas with secure edges, suitable drainage and optional
