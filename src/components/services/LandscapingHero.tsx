      ...
      <div className="max-w-[1280px] mx-auto px-6 w-full relative z-10 py-[30px] lg:py-0">
        ...
        >
          ...
          <div className="max-w-[580px]">
            ...
            >
              Bring the main parts of your outdoor space together with a practical landscaping
              plan. Total Driveways and Patios can combine paving, paths, turf, fencing, walls,
              beds and changes of level to create a garden that is easier to use and maintain.
            </motion.p>
