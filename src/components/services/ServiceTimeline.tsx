...
const steps = [
  {
    ...
    desc: "Visiting your property to measure, discuss ideas and understand your vision.",
    icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z",
  },
  {
    num: "02",
    title: "Design & Quote",
    desc: "A detailed design and transparent quote with no hidden costs or surprises.",
    icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
  },
  {
    num: "03",
    title: "Ground Prep",
    desc: "Excavating and preparing a stable sub-base with proper drainage and compaction.",
    icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z",
  },
  {
    num: "04",
    title: "Block Installation",
    desc: "Expert laying of your chosen blocks in the selected pattern with precision.",
    icon: "M3 3h18v18H3V3z M9 3v18 M15 3v18 M3 9h18 M3 15h18",
  },
  {
    num: "05",
    title: "Finishing Touches",
    desc: "Compacting, sealing and cleaning — leaving a stunning ready-to-use driveway.",
    icon: "M5 13l4 4L19 7",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5">
          {steps.map((step, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              custom={i}
              variants={{ hidden: { opacity: 0, y: 30 }, visible: (j) => ({ opacity: 1, y: 0, transition: { duration: 0.5, delay: j * 0.12, ease: [0.25, 0.1, 0.25, 1] } }) }}
