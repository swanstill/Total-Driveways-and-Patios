...
const features = [
  {
    ...
    desc: "A perfectly flat, joint-free surface that looks clean and contemporary. No weeds, no loose blocks — just a smooth, uniform finish that's comfortable underfoot.",
    icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z",
  },
  {
    title: "Wide Colour & Aggregate Choice",
    desc: "Choose from an extensive palette of natural aggregates and colours to match your home's style. From warm ochres and rich greys to cool blues and earthy browns.",
    icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01",
  },
  {
    title: "Modern, Contemporary Appearance",
    desc: "Resin surfacing creates a sleek, minimalist look that complements both modern extensions and period properties looking for a fresh, clean kerb appeal.",
    icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
  },
  {
    title: "Low Maintenance & Easy to Clean",
    desc: "Resin-bound surfaces are naturally porous (SUDS compliant), resistant to staining and algae, and can be cleaned with a simple hose-down or occasional jet wash.",
    icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
  },
];

export default function ResinWhyChooseUs() {
  return (
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div>
            ...
            >
              Resin driveways offer a stunning, contemporary alternative to traditional paving.
              With a seamless finish, UV-stable resins, and a huge choice of natural aggregates,
              they combine modern aesthetics with practical, low-maintenance performance that
              lasts for years.
            </motion.p>
