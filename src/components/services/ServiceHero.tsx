...
export default function ServiceHero() {
  return (
    ...
    >
      ...
      {/* 1. Subtle herringbone-inspired grid — nod to block paving */}
      <div
        className="absolute inset-0 opacity-[0.04]"
        style={{
          backgroundImage: `
            repeating-linear-gradient(45deg, transparent, transparent 28px, rgba(15,39,71,0.06) 28px, rgba(15,39,71,0.06) 29px),
            repeating-linear-gradient(-45deg, transparent, transparent 28px, rgba(15,39,71,0.06) 28px, rgba(15,39,71,0.06) 29px)
          `,
      ...
      {/* 2. Large ambient glow — top right */}
      <div
      ...
      {/* 5. Top-right decorative corner bracket */}
      <div
      ...
      {/* === Main Content === */}
      <div className="max-w-[1280px] mx-auto px-6 w-full relative z-10 py-28 lg:py-0">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <div className="max-w-[580px]">
            ...
            >
              <span className="block">Block Paving</span>
              <span className="block">Driveways</span>
              <span
            ...
            >
              ...
              traditional herringbone to contemporary basket-weave — we design and build
              driveways with meticulous preparation beneath the surface and a flawless
              finish above it.
            </motion.p>
          ...
          >
            <div className="relative pl-8">
              ...
              {/* Floating rating badge — overlaps the image bottom-left */}
              <motion.div
