    ...
    <section className="py-[120px]" style={{ background: "var(--svc-section)" }}>
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        >
          ...
          >
            Drag the slider to compare the before and after of a recent block paving project in Barnsley.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            {/* After (full image) */}
            <div className="absolute inset-0" style={{ background: "url('/after-block-paving.jpeg') center/cover no-repeat" }} />

            {/* Before (clipped) */}
            <div
              className="absolute inset-0"
              style={{
                background: "url('/before-block-paving.jpeg') center/cover no-repeat",
