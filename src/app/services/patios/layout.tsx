...
export const metadata: Metadata = {
  ...
  description:
    "Expert patio installation across Barnsley and South Yorkshire. Indian sandstone, porcelain, block paving patios. Free quotes, premium materials, 5-year guarantee. Call 0800 994 9855.",
